              ...
              <DropdownMenuContent align="end" className="w-72">
                ...
                <DropdownMenuItem className="cursor-pointer">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Anita Sharma needs a Math tutor for Riya</p>
                  </div>
                </DropdownMenuItem>
                <DropdownMenuItem className="cursor-pointer">
                  <div className="flex flex-col gap-1">
                    <p className="text-sm font-medium">Demo confirmed</p>
                    <p className="text-xs text-muted-foreground">Dr. Meena Iyer confirmed demo with Siddharth</p>
                  </div>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
